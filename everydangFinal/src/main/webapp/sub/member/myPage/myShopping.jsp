                        ...
                        <div class="order-info">
                            <div class="info-wrap">
                                ...
                                <div class="info-lists">
                                    <div class="info-item">
                                        <div class="prod-info">
                                            <p id="prod-name">에브리댕 강아지 옷</p>
                                            <p class="prod-option">
                                                <span id="prod-price">15,000</span>원 / 수량 <span id="prod-total">1</span>개
                                            </p>
                                        </div>
                                        <div class="btn-wrap">
                                            <form action="#">
                                                <button class="btn" id="btn-review" data-bs-toggle="modal" data-bs-target="#reviewModal">리뷰쓰기</button>
                                                <button class="btn" id="btn-refund">주문취소/환불</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
...
<!--                                             <div class="point text-info">
                                        ...
                                        <div class="credit-total text-info">
                                            ...
                                            <span class="txt"><i id="total">20,000</i>원</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="info-lists">
                                    <div class="text-info">
                                        <div class="text-info-item">
                                            <p class="title">수령인</p>
                                            <span class="txt" id="receiver">김대덕</span>
                                        </div>
                                        <div class="text-info-item">
                                            <p class="title">연락처</p>
                                            <span class="txt" id="user-tel">010-0000-0000</span>
                                        </div>
                                        <div class="text-info-item">
                                            <p class="title">주소</p>
                                            <span class="txt" id="user-addr">대전 중구 오류동 대덕인재개발원 402호</span>
                                        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="modal-form">
                    ...
                    <div class="btn-wrap">
                        <button type="button" class="btn btn-primary" id="btn-review-submit">작성하기</button>
                    </div>
            </div>
        </div>
        </div>
