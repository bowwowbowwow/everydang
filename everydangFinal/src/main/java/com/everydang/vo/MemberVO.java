...
public class MemberVO {
	...
	public int getMm_grade_noti() {
		return mm_grade_noti;
	}
	public void setMm_grade_noti(int mm_grade_noti) {
		this.mm_grade_noti = mm_grade_noti;
	}
